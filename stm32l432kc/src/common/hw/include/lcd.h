...
// lcd의 여러가지 드라이버들을 쓸 수도 있는데 이때 드라이버 구조체를 이용해서 드라이버 코드를 함수 포인터의 집합으로 만든후 lcd각각 컨트롤 헤더에서 include한후 initDriver
// 자기 가 갖고 있는 함수들을 함수 포인터로 연결해줌
// 여러개의 컨트롤러도 따라서 쓸 수 있게 할 수 있음
// 조금은 복잡함
